...
[global]
logfile="stdout"  # Перенаправляем внутренние логи ulogd в stdout
loglevel=3
...
[json1]
file="stdout" # Перенаправляем логи пакетов INPUT в stdout юнита systemd

[json2]
file="stdout" # Перенаправляем логи пакетов FORWARD в stdout юнита systemd